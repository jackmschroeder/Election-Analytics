...
#setwd("~/Google Drive Harvard/Courses/Gov1347-ElectionAnalysis-2020/Sections-Public/03-Polling")
...
#####  Predicting 2020 ####
#####------------------------------------------------------#
dat_2020_inc <- data.frame(GDP_growth_qt = -0.0949, avg_support = 50)
dat_2020_chl <- data.frame(GDP_growth_qt = -0.0949, avg_support = 50)

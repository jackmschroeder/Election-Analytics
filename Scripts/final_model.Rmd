...
results <- states %>% 
  mutate(R_pv2p = rep/(rep+dem),
         ...
         Guide = ifelse(R_pv2p > D_pv2p, ifelse(abs(R_pv2p - D_pv2p) > .0592, "Favor Trump", "Lean Trump"), ifelse(abs(D_pv2p - R_pv2p) < .0592, "Lean Biden", "Favor Biden")))
